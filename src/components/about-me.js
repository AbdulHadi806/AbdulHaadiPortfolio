    ...
    return (
        ...
        >
            <motion.div
                ...
                className={`col-sm-6 col-lg-5 d-flex ${styles.imgColLeft}`}
            >
                <Image
            ...
            <motion.div 
            transition={{ staggerChildren: 0.5 }} className="col-md-12 col-lg-7 text-start">
                <div className={styles.titleRow}>
                    <Commontitle mainHeadingAnimation={mainHeadingAnimation}
                        title={data.AboutMe.titleMain}
                ...
                <div className={`d-flex ${styles.buttonRow}`}>
                    <motion.div variants={buttonAnimation}
                        className={`text-center ${
                            modeToggler ? '' : styles.darkModeBtnMain
                        } ${styles.btns}`}
                    >
                        <Link
                            to ="Contact"
