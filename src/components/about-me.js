...
export default function Aboutme({ modeToggler }) {
    ...
    const imageAnimation={offscreen:{opacity:0,y:100},onscreen:{y:0,opacity:1,transition:{type:"scale",bounce:.9,duration:2,delay:.3}}},mainHeadingAnimation={offscreen:{opacity:0,x:-100},onscreen:{x:0,opacity:1}},buttonAnimation={offscreen:{opacity:0,y:100},onscreen:{y:0,opacity:1,transition:{type:"bounce",bounce:.9,duration:.3,delay:.2}}};
    return (
