...
const Skillsrow = ({modeToggler}) => {
    ...
    const mainHeadingAnimation={offscreen:{opacity:0,x:-100},onscreen:{x:0,opacity:1}},pAnimation={offscreen:{opacity:0,y:100},onscreen:{y:0,opacity:1}},skillsAnimation={offscreen:{opacity:0},onscreen:{opacity:1},transition:{delay:.2,duration:.4}};
    return (
